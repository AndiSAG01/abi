...
@section('content')
                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="container mt-3">
                                <div class="card shadow-lg">
                                    <h3 class="card-header bg-primary text-white text-center"
                                        style="font-family: 'Abril Fatface', cursive;">List Pilihan Destinasi Tour</h3>
                                    <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ml-2">
                                                                    ...
                                                                    <p class="mb-0 text-muted">Lokasi:
                                                                        <?= esc($item['tour_location']) ?></p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td><?= 'Rp ' . number_format($item['tour_ticket'], 0, ',', '.') ?>
                                                        </td>
                                                        <td>
                                                            <ul class="mb-0 ps-3">
                        ...
                        <div class="carousel-item">
                            <div class="container mt-3">
                                <div class="card shadow-lg">
                                    <h3 class="card-header bg-primary text-white text-center"
                                        style="font-family: 'Abril Fatface', cursive;">Form Transaksi</h3>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 mt-3 mt-md-0">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control rounded-pill <?= session('errors.customer_name') ? 'is-invalid' : '' ?>"
                                                        id="nama" name="customer_name"
                                                        value="<?= old('customer_name', esc($customers->username ?? '')) ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"
                                                        class="form-control rounded-pill <?= session('errors.customer_phone') ? 'is-invalid' : '' ?>"
                                                        id="no_hp" name="customer_phone"
                                                ...
                                                <div class="form-group">
                                                    <label for="total_people" class="font-weight-bold">Jumlah
                                                        Peserta</label>
                                                    <input type="text"
                                                        class="form-control rounded-pill <?= session('errors.total_people') ? 'is-invalid' : '' ?>"
                                                        id="total_people" name="total_people"
                                                ...
                                                <div class="form-group">
                                                    <label for="start_date" class="font-weight-bold">Tanggal
                                                        Keberangkatan</label>
                                                    <input type="date"
                                                        class="form-control rounded-pill <?= session('errors.start_date') ? 'is-invalid' : '' ?>"
                                                ...
                                                <div class="form-group">
                                                    <label for="end_date" class="font-weight-bold">Tanggal
                                                        Kepulangan</label>
                                                    <input type="date"
                                                        class="form-control rounded-pill <?= session('errors.end_date') ? 'is-invalid' : '' ?>"
                        ...
                        <div class="carousel-item">
                            <div class="container">
                                <div class="card shadow-lg rounded-4">
                                    <h3 class="card-header bg-primary text-white text-center"
                                        style="font-family: 'Abril Fatface', cursive;">Item Detail</h3>
                                    <span class="p-3 text-danger text-center d-block">Note: Item Tidak Wajib Dipilih Jika
                                        Tidak Ingin Menambah Perlengkapan</span>
                                    <div class="card-body">
                                        <div class="row">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-success  rounded-pill">Kirim
                                                Transaksi</button>
                                        </div>
                                    </div>
                                </div>
    ...
    @include('customers.transaction.js');
@endsection
