            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img" style="background-image: url(/assets/images/bg_2.jpg);">
                        ...
                        <p class="mb-0"><a href="/destination" class="btn btn-primary px-4 py-3">Mulai Perjalan Anda</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mb-5">
                <div class="col-md pt-5">
                    <div class="ftco-footer-widget pt-md-5 mb-4">
                        ...
                        <p>Jauh di barat Pulau Sumatra, di kaki Gunung Kerinci yang megah, terbentang sebuah negeri yang kaya akan keindahan alam dan budaya—Kerinci. Dikenal sebagai "Sekepal Tanah Surga," daerah ini menyimpan pesona luar biasa yang memikat siapa saja yang datang mengunjunginya.</p>
                ...
                <div class="col-md pt-5 border-left">
                    <div class="ftco-footer-widget pt-md-5 mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon fa fa-map-marker"></span><span class="text">JR Taman Rindu Gunung Selasih Semurup, Sekungkung, Depati Tujuh, Kerinci Regency, Jambi 37152, Indonesia</span></li>
                                <li><a href="https://api.whatsapp.com/send/?phone=6282181350150&text&type=phone_number&app_absent=0"><span class="icon fa fa-phone"></span><span class="text">+62 821-8135-0150</span></a></li>
                                <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">frescotrip@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
